...
int main() {
    ...
    slist = insert_node_front(slist, "Army of the People", "Red Army Choir");
    slist = insert_node_front(slist, "Combat Reconniassance", "Vladimir Vysotskiy");
    slist = insert_node_front(slist, "Alexandrov's Song", "Red Army Choir");
